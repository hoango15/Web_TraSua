...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (!isset($_SESSION['error'])) {
    if ($is_edit) {
      ...
      // Insert new slider - no need to specify updated_at and created_at if they have defaults
...
<body>
  ...
  <script>
    ...
    document.getElementById('image').addEventListener('change', function(e) {
      const file = e.target.files[0]; // Fixed index from [1] to [0]
    ...
    // Make the entire upload button area clickable
