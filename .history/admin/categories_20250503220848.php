...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    if ($product_count > 0) {
        $error_message = "Không thể xóa loại sản phẩm này. Nó đang có $product_count sản phẩm trong nó.";
    } else {
        ...
        if ($delete_stmt->execute()) {
            $success_message = "Xóa loại sản phẩm thành công .";
        } else {
            $error_message = "Lỗi xóa sản phẩm .";
        }
    }
}
